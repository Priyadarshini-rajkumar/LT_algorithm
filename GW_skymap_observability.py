...
bayestar_dir            = "/data1/extprajk/GW170817/LALInference_v2.fits.gz"  # local directory of the bayestar map from GRACEDB website.
...
time                    = Time("2018-06-26 23:00") # Date and time at which the probabilty must be be calculated.
#or
#time                    = time.now()
